...
public class Split2MinDom {
    ...
    public void reportSolution() {
        ...
        System.out.println("Number of wrong decisions = " + wrongDecisions + " and total nodes = " + totalNodes);
        ...
        IntVar selectVariable(IntVar[] v) {
            if (v.length != 0) {
                ...
                for (int i = 0; i < v.length; i++) {
                    ...
                    if (v[i].max() - v[i].min() < minDom) {
                        minDom = v[i].max() - v[i].min();
                        index = i;
                    }
                }
